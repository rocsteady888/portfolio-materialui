        ...
        <Grid container spacing={24}>
          <Grid item xs={12} sm={6} md={4}>
            <ComplexCard
              ...
              headline={"Full stack application using the MERN stack. React-Redux, Express, Mongoose, MongoDB.  This app solves a common issue for many companies with unusual work hours or self employed people. People that work 24 hour shifts, overnight shifts, or self employed people have few options for keeping track of the hours they have put in."}
